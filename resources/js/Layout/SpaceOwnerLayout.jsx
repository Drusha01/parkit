...
export const SpaceOwnerLayout = ({ children }) => {
    ...
    return (
        <>
            <div className='flex min-h-full dark:bg-gray-900'>
                <div
                    className={`${
                        isOpen ? 'w-[250px]' : 'w-[70]'
                    }  bg-blue-950 dark:bg-gray-800 min-h-full transition-all duration-300 ease-in-out  `}
                    >
                    <div className="p-2">
                        <SpaceOwnerNav props={isOpen}/>
                    </div>
                </div>
                <div className='h-full flex-1'>
                    <header className="shadow-lg min-h-[70] dark:bg-gray-700"  >
                        <div className="flex justify-between pt-3">
                        <button className="flex justify-start align-middle   hover:bg-gray-200 dark:text-gray-200  dark:hover:bg-gray-700 hover:text-black ml-5 p-3 rounded-xl" onClick={toggleSidebar}>
