                ...
                <main className="dark:text-white text-black">
                    ...
                    <div>
                        <EditModal isOpen={isEditModalOpen} closeModal={closeEditModal} FuncCall={HandleTopUp} Size={'w-full mx-1 md:w-8/12'} title={`${details.isTopUp ? 'Top-up balance' : 'Void balance'}`} className="text-black">
                            ...
                            <div className="ml-2 mr-1 mt-2">
                                <label for="password" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Password <span className="text-red-600">*</span></label>
                                <input type="password" min="1" required id="password" value={details.password} onChange={handleChange} className="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="09876543210"  
                                    />
                            </div>
