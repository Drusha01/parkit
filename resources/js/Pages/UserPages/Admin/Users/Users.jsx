...
export default function Users(data) {
    ...
    const HandleToggleIsActive = (e) =>{
        ...
        axios.post( "/admin/users/toggle_is_active" , {  
            id: details.id,
        })
        .then(res => {
                                            ...
                                            (content.data.map((item, index) => (
                                                <tr key={item.id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td className="text-center flex justify-center gap-2 mt-2 md:mt-4">
                                                        <button onClick={() => HandleGetDetails(item.id, openViewModal)} className="md:hidden table-cell text-center focus:outline-none bg-white text-black border border-black  hover:bg-gray-200 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-md">
                        ...
                        <ViewModal isOpen={isViewModalOpen} closeModal={closeViewModal} Size={'w-full mx-1 md:w-8/12'} title="User Details" className="text-black">
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="type" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Full name <span className="text-red-700">*</span></label>
                            ...
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="name"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Email <span className="text-red-700">*</span></label>
                            ...
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="name"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Gender <span className="text-red-700">*</span></label>
                                    <input type="text" id="name" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="name"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Birthdate <span className="text-red-700">*</span></label>
                                    <input type="date" id="name" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="Name" disabled required  value={details.birthdate} />
                                </div>
                            </div>
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="name"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Verified? </label>
