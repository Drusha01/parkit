                    ...
                    <div className="content">
                        <div className="content-header my-2 mx-1 md:mx-4">
                            ...
                            <div className="flex justify-end h-16">
                                <button type="button" onClick={openAddModal} className="mt-5 mr-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    Add
                                </button>
                            </div>
                        </div>
                                                ...
                                                <tr key={item.id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td className="py-4 hidden md:table-cell text-center">
                                                        {item.email_verified == 1 ? (
                                                            <span className="inline-block px-3 py-1 text-md font-medium text-green-700  rounded-full">
                                                            ...
                                                            <span className="inline-block px-3 py-1 text-md font-medium text-red-700  rounded-full">
                                                    ...
                                                    <td className="text-center flex justify-center gap-2 mt-2 md:mt-4">
                                                        ...
                                                        <button onClick={() => HandleGetDetails(item.id, openEditModal)} className="focus:outline-2  border hover:bg-green-800 hover:text-white focus:ring-4 focus:ring-green-600 border-green-700 bg-white text-green-700  font-medium rounded-lg text-md">
                    ...
                    <div>
                        <ViewModal isOpen={isViewModalOpen} closeModal={closeViewModal} Size={'w-full mx-1 md:w-8/12'} title="Staff Details" className="text-black">
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="email"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Email <span className="text-red-700">*</span></label>
                                    <input type="email" id="email" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="first_name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">First name <span className="text-red-700">*</span></label>
                                    <input type="text" required id="first_name" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                ...
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    ...
                                    <input type="text" id="middle_name" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="Middle name" disabled onChange={HandleChange}  value={details.middle_name}  />
                                </div>
                            </div>
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="last_name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Last name <span className="text-red-700">*</span></label>
                                    <input type="text" required id="last_name" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                ...
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    ...
                                    <input type="text" id="suffix" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="suffix" disabled onChange={HandleChange}   value={details.suffix} />
                                </div>
                            </div>
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="gender"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Gender</label>
                                    <select 
                                    id="gender"  
                                    disabled
                                ...
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="birthdate"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Birthdate <span className="text-red-700">*</span></label>
                                    <input type="date" id="birthdate" min="0"  className="disabled:bg-gray-200 dark:disabled:bg-gray-700 dark:bg-gray-900 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                        ...
                        <AddModal isOpen={isAddModalOpen} closeModal={closeAddModal} Size={'w-full mx-1 md:w-8/12 min-h-10/12'} FuncCall={HandleAddStaff} title="Add Staff" className="text-black">
                            <div className="mb-2">
                                <div className="w-full">
                                    <label for="email"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Email <span className="text-red-700">*</span></label>
                                    <input type="email" id="email" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="first_name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">First name <span className="text-red-700">*</span></label>
                                    <input type="text" required id="first_name" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="First name" onChange={HandleChange} value={details.first_name}  />
                                </div>
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="middle_name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Middle name </label>
                                    <input type="text" id="middle_name" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="last_name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Last name <span className="text-red-700">*</span></label>
                                    <input type="text" required id="last_name" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="Last name" onChange={HandleChange}  value={details.last_name}  />
                                </div>
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="suffix"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Suffix </label>
                                    <input type="text" id="suffix" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                ...
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="birthdate"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Birthdate <span className="text-red-700">*</span></label>
                                    <input type="date" id="birthdate" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="Name" required onChange={HandleChange}  value={details.birthdate} />
                                </div>
                            </div>
                            <div className="mb-2 grid grid-cols-2 gap-1">
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="birthdate"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Password <span className="text-red-700">*</span></label>
                                    <input type="password" id="password" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        placeholder="Password" required    onChange={HandleChange}  value={details.password} />
                                </div>
                                <div className="w-full col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 xxl:col-span-1">
                                    <label for="birthdate"  className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">ConfirmPassword <span className="text-red-700">*</span></label>
                                    <input type="password" id="confirm_password" min="0"  className="disabled:bg-gray-200 bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                        ...
                        <DeactivateModal isOpen={isDeactivateModalOpen} closeModal={closeDeactivateModal} FuncCall={HandleToggleIsActive} title="Deactivate Staff">
                            <div className="text-center mt-5 text-red-600">Are you sure you want to deactivate this?</div>
                        </DeactivateModal>
                        <ActivateModal isOpen={isActivateModalOpen} closeModal={closeActivateModal} FuncCall={HandleToggleIsActive} title="Activate Staff">
