                    ...
                    <div>
                        <AddModal isOpen={isAddModalOpen} closeModal={closeAddModal} FuncCall={HandleAdd} Size={'w-full mx-1 md:w-8/12'} title="Add Vehicle Types" className="text-black">
                            ...
                            <div className="w-full mb-2">
                                <label for="icon" required className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Icon  <span className="text-red-600">*</span></label>
                            ...
                            <div className="mb-2">
                                ...
                                <textarea id="description" rows="4"  value={details.description} onChange={handleChange} className="block p-2.5 w-full text-md text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                        ...
                        <EditModal isOpen={isEditModalOpen} closeModal={closeEditModal} FuncCall={HandleEdit} Size={'w-full mx-1 md:w-8/12'} title="Edit Vehicle Types" className="text-black">
                            ...
                            <div className="w-full mb-2">
                                <label for="icon" className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Icon  </label>
                                <input  className="block w-full text-md text-gray-900 border border-black rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" 
                                    id="icon" name='icon' accept="image/*" type="file"  onChange={handleFileChange} />
                            </div>
                            <div className="mb-2">
                        ...
                        <ViewModal isOpen={isViewModalOpen} closeModal={closeViewModal} Size={'w-full mx-1 md:w-8/12'} title="View Vehicle Types" className="text-black">
                            ...
                            <div className="mb-2">
                                <label for="description" class="block mb-1 text-md font-medium text-gray-900 dark:text-white">Description</label>
                                <textarea id="description" rows="4" disabled  value={details.description} onChange={handleChange} className=" dark:disabled:bg-gray-700 block p-2.5 w-full text-md text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    placeholder="description ..."
                                >
                                </textarea>
                            </div>
