                ...
                <main className="dark:text-white text-black">
                    ...
                    <div>
                        <ViewModal isOpen={isViewModalOpen} closeModal={closeViewModal} title="Vehicle Details" Size={'w-full mx-2 md:w-8/12 '}>
                            ...
                            <div className="mb-2">
                                <label for="brand" className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Brand </label>
                                <input type="text" id="brand" value={details.brand}  disabled className="bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    placeholder="Brand" required />
                            </div>
                            <div className=" mb-2">
                                <label for="unit" className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Unit </label>
                                <input type="text" id="unit" disabled value={details.unit}  className="bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    placeholder="Unit ... " />
                            </div>
                            <div className="mb-2">
                                <div className="w-full">
                            ...
                            <div className="w-full mb-2 ">
                                <label for="icon" className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Back Side of Vehicle  </label>
                                <div className="flex justify-center">
