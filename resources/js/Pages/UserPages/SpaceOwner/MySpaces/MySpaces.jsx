                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-gray-700 uppercase bg-gray-300 dark:bg-gray-200 dark:text-black">
                                        <tr className="text-md">
                                            ...
                                            <th scope="col" className="py-3 hidden md:table-cell">Rules</th>
                                            <th scope="col" className="py-3 hidden md:table-cell">Location</th>
                                            <th scope="col" className="py-3 hidden md:table-cell text-center">Approval Status</th>
