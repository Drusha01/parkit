                                                                ...
                                                                vehicleAllotments.map((item, index) => (
                                                                    <tr key={index} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                                        ...
                                                                        <td className="text-center mt-2 flex gap-2">
                                                                            <button onClick={() => HandleGetVehicleAllotment(index,openViewModal)} className="text-center focus:outline-none bg-white text-black border border-black  hover:bg-gray-200 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-md">
                                                                            ...
                                                                            <button onClick={() => HandleGetVehicleAllotment(index,openEditModal)} className="focus:outline-2  border hover:bg-green-800 hover:text-white focus:ring-4 focus:ring-green-600 border-green-700 bg-white text-green-700  font-medium rounded-lg text-md">
                                                                            ...
                                                                            <button onClick={() => deleteVehicleAllotment(index)} className="focus:outline-2  border hover:bg-red-800 hover:text-white focus:ring-4 focus:ring-red-600 border-red-700 bg-white text-red-700  font-medium rounded-lg text-md">
                                                                            ...
                                                                            {/* <button type="button" onClick={() => HandleGetVehicleAllotment(index,openViewModal)} className="mx-2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-md px-3 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</button>
                                                                            <button type="button" onClick={() => HandleGetVehicleAllotment(index,openEditModal)} className="mx-2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-md px-3 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</button>
                                                                            <button type="button" onClick={() => deleteVehicleAllotment(index)} className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-md px-3 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Delete</button> */}
                                                                        </td>
                                                                    </tr>
                                                                ))
                                                            ) : (
                                                                ...
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 lg:ml-0 lg:mr-1 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        ...
                                                                        <input type="number" id="flat_rate_month" min="0" value={values.flat_rate_month} onChange={handleChange} 
                                                                            className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                        ...
                                                        <ViewModal isOpen={isViewModalOpen} closeModal={closeViewModal} title="View vehicle allotment">
                                                            <div className="w-full grid mb-2 grid-cols-4">
                                                                ...
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Duration Fee</label>
                                                                        <input type="number" id="duration_fee" min="0" disabled value={values.duration_fee} onChange={handleChange} className="disabled:bg-gray-400 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration fee"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 lg:ml-0 lg:mr-1 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Months</label>
                                                                        <input type="number" id="duration_month" min="0" disabled value={values.duration_month} onChange={handleChange} className="disabled:bg-gray-400 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration in months"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 lg:ml-0 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Days</label>
                                                                        <input type="number" id="duration_day" min="0" disabled value={values.duration_day} onChange={handleChange} className="disabled:bg-gray-400 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration in days"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 ml-0 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Hours</label>
                                                                        <input type="number" id="duration_hour" min="0" disabled value={values.duration_hour} onChange={handleChange} className="disabled:bg-gray-400 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration in hours"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 mr-1 mb-2">
                                                        ...
                                                        <EditModal isOpen={isEditModalOpen} closeModal={closeEditModal} FuncCall={HandleEditRent} title="Edit vehicle allotment">
                                                            <div className="w-full grid mb-2 grid-cols-4">
                                                                ...
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white ">Duration Fee</label>
                                                                        <input type="number" name="edit_duration_fee" id="duration_fee" min="0" value={values.duration_fee} onChange={handleChange} className="disabled:bg-gray-200  disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration fee"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 lg:ml-0 lg:mr-1 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Months</label>
                                                                        <input type="number" name="edit_duration_month" id="duration_month" min="0" value={values.duration_month} onChange={handleChange} className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration in months"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 lg:ml-0 mr-1 mb-2">
                                                                ...
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 ml-0 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Hours</label>
                                                                        <input type="number" name="edit_duration_hour" id="duration_hour" min="0" value={values.duration_hour} onChange={handleChange} className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Duration in hours"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white">Flat Rate Fee</label>
                                                                        <input type="number" name="edit_flat_rate_fee" id="flat_rate_fee" min="0" value={values.flat_rate_fee} onChange={handleChange} className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Flat rate fee"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 lg:ml-0 lg:mr-1 mr-1 mb-2">
                                                                ...
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:ml-5 lg:ml-0 mr-1 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Days</label>
                                                                        <input type="number" name="edit_flat_rate_day" id="flat_rate_day" min="0" value={values.flat_rate_day} onChange={handleChange} className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Flat rate duration in days"  />
                                                                    </div>
                                                                </div>
                                                                <div className="col-span-4 md:col-span-2 lg:col-span-1 md:mr-5 ml-0 mb-2">
                                                                    <div className="w-full">
                                                                        <label for="name" className="block mb-1 text-md font-medium text-gray-900 dark:text-white"> Hours</label>
                                                                        <input type="number" name="edit_flat_rate_hour" id="flat_rate_hour" min="0" value={values.flat_rate_hour} onChange={handleChange} className="disabled:bg-gray-200 disabled:text-black bg-gray-50 border border-black text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                                            placeholder="Flat rate duration in hours"  />
                                                                    </div>
                                                                </div>
                                                            </div>
