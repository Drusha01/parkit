...
export default function Feedback() {
    ...
    const GetData = () =>{
        axios.post( "/spaceowner/feedback/all" , {  
            rows: content.rows,
    ...
    const HandleGetDetails = (id,modalFunc)=>{
        axios.get( "/spaceowner/feedback/view/"+id )
        .then(res => {
            modalFunc();
                                ...
                                <table className="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <thead className="text-md text-gray-700 uppercase bg-gray-300 dark:bg-gray-200 dark:text-black">
                                        <tr className="text-md">
                                            ...
                                            <th className="pr-1 py-1 font-semibold text-gray-600">Remarks</th>
                                        </tr>
                                    </thead>
                                    <tbody>
