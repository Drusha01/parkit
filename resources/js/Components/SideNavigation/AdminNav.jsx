        ...
        <>
           <nav className=" bg-main-color">
                <ul className="">
                    ...
                    <li className={url === "/admin/feedback" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
                        <Link href="/admin/feedback" className="flex h-full gap-2 mx-3">
                    ...
                    <li className={url === "/admin/history" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
                        <Link href="/admin/history" className="flex h-full gap-2 mx-3">
                    ...
                    <li className={url === "/admin/notifications" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
