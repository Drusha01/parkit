        ...
        <>
           <nav className=" bg-blue-950">
                <ul className="">
                    ...
                    <li className={url === "/admin/staff" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
                        <Link href="/admin/staff" className="flex h-full gap-2 mx-3">
