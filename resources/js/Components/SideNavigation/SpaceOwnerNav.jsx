...
export const SpaceOwnerNav = ({props}) => {
    ...
    const [spaces,setSpaces] = useState(usePage().props.active_spaces)
    return (
        <>
            <nav className=" bg-blue-950 dark:bg-gray-800">
                <ul className="whitespace-nowrap">
                    ...
                    {(spaces !== null) && (
                        <li className={url === "/spaceowner/scan" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
                            <Link href="/spaceowner/scan" className="flex h-full gap-2 mx-3">
