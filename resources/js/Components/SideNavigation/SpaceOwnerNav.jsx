        ...
        <>
           <nav className="w-[300px] h-full fixed top-0 left-0 bg-main-color hidden lg:flex">
                <ul className="w-[250px] my-5 ml-[25px] ">
                    ...
                    <li className={url === "/spaceowner/spaces" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/feedback" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/helpandsupport" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/history" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/notifications" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/wallet" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/profile" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                    ...
                    <li className={url === "/spaceowner/logout" ? "w-[250px] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[250px] h-12 rounded-md text-white hover:bg-blue-900"}>
                        <Link href="" className="flex h-full gap-2 mx-3">
                            <svg viewBox="0 0 24 24" width="32"fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15 16.5V19C15 20.1046 14.1046 21 13 21H6C4.89543 21 4 20.1046 4 19V5C4 3.89543 4.89543 3 6 3H13C14.1046 3 15 3.89543 15 5V8.0625M11 12H21M21 12L18.5 9.5M21 12L18.5 14.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
                            <div className="mt-3">
                                Logout
                            </div>   
                        </Link>
