        ...
        <>
           <nav className=" bg-main-color">
                <ul className="">
                    ...
                    <li className={url === "/spaceowner/logout" ? "w-[w-full] h-12 rounded-md text-white bg-blue-900 hover:bg-blue-900" : "w-[w-full] h-12 rounded-md text-white hover:bg-blue-900"}>
