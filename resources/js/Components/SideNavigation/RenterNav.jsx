...
export const RenterNav = (props) => {
    ...
    return (
        <>
            <div className="hidden xl:flex w-1/5 dark:bg-gray-800 dark:text-white">
                <ul className="my-5 w-full whitespace-nowrap">
                    <li className="">
                        <Link href="/renter/profile" className={url === "/renter/profile" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                    ...
                    {license === null  && (
                        <li>
                            <Link href="/renter/registration" className={url === "/renter/registration" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                    ...
                    <li>
                        <Link href="/renter/license" className={url === "/renter/license" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                            <svg className="0 ml-1"  width="25px" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                    ...
                    <li>
                    <Link href="/renter/vehicles" className={url === "/renter/vehicles" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                    ...
                    <li>
                        <Link href="/renter/wallet" className={url === "/renter/wallet" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                    ...
                    <li>
                        <Link href="/renter/top-ups" className={url === "/renter/top-ups" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                            <svg fill="currentColor" viewBox="0 0 24 24" width="30px" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M4,5A1,1,0,0,0,5,6H21a1,1,0,0,1,1,1V21a1,1,0,0,1-1,1H16a1,1,0,0,1,0-2h4V8H5a2.966,2.966,0,0,1-1-.184V19a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1V14.414L9.707,15.707a1,1,0,0,1-1.414-1.414l3-3a.99.99,0,0,1,.326-.217,1,1,0,0,1,.764,0,.99.99,0,0,1,.326.217l3,3a1,1,0,0,1-1.414,1.414L13,14.414V19a3,3,0,0,1-3,3H5a3,3,0,0,1-3-3V5A3,3,0,0,1,5,2H21a1,1,0,0,1,0,2H5A1,1,0,0,0,4,5Z"></path></g></svg>
                            <div className="mt-1">
                                Top Ups
                            </div>
                        </Link>
                    ...
                    <li>
                        <Link href="/renter/history" className={url === "/renter/history" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                    ...
                    <li>
                        <Link href="/renter/privacy" className={url === "/renter/privacy" ?  "flex align-middle gap-2 px-4 py-2 mx-5 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg" : "flex align-middle gap-2 px-4 py-2 mx-5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-lg"}>
                            <svg viewBox="0 0 192 192" width="30px" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g fill="none" stroke="currentColor" stroke-width="12"> <path stroke-linecap="round" d="M151.8 144.5a74 74 0 0 1-85.59 19.21A74 74 0 0 1 22.42 87.7a74 74 0 0 1 59.55-64.42m28.03.06a74 74 0 0 1 50.06 35.61 74 74 0 0 1 5.915 61.15"></path> <path d="M76 92h40c4.432 0 8 3.568 8 8v22c0 4.432-3.568 8-8 8H76c-4.432 0-8-3.568-8-8v-22c0-4.432 3.568-8 8-8zm4 0V77.7C80 69.029 87.163 62 96 62s16 7.029 16 15.7V92"></path> </g> </g></svg>
                            <div className="mt-1">
                                Privacy 
                            </div>
                        </Link>
