        ...
        <>
            <div className="hidden lg:flex  w-1/5">
                <ul className="my-5 w-full">
                    <li className="">
                        <Link href="/renter/profile" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="/renter/registration" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="/renter/vehicles" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="/renter/wallet" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="/renter/history" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="#" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li>
                        <Link href="/renter/privacy" className="flex align-middle gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
